...
class imageController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    { // sending image to another view
        if segue.identifier == "showImage"{
            let destViewController: viewImageController = segue.destinationViewController as! viewImageController
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        view.bringSubviewToFront(takePhoto)
        view.bringSubviewToFront(upload)
